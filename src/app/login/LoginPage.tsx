  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(180deg, #020617 0%, #0f172a 50%, #1e1b4b 100%)", padding: "2rem" }}>
      <div style={cardStyle}>
        ...
        {/* Step 1: Google Sign-In (Required First) */}
        {step === "google" && (
          <div>
            <div style={{ textAlign: "center", marginBottom: "1rem" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", padding: "0.3rem 0.8rem", borderRadius: 6, background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.2)", marginBottom: "1rem" }}>
                <span style={{ fontSize: "0.7rem", color: "#93c5fd", fontWeight: 600 }}>Step 1 of 2</span>
              </div>
              <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginBottom: "1.25rem", lineHeight: 1.5 }}>
                First, sign in with your Google account to link your identity. Then you will enter your organization credentials.
              </p>
            </div>
        ...
        {/* Step 2: Org Credentials (Required Second) */}
        {step === "credentials" && (}
        {step === "credentials" && (
          <div>
            {googleUser && (
            ...
            <div style={{ textAlign: "center", marginBottom: "1rem" }}><div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", padding: "0.3rem 0.8rem", borderRadius: 6, background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)", marginBottom: "1rem" }}><span style={{ fontSize: "0.7rem", color: "#6ee7b7", fontWeight: 600 }}>Step 2 of 2</span></div><p style={{ fontSize: "0.85rem", color: "#94a3b8", marginBottom: "1rem" }}>Now enter your NTRO organization ID and password:</p></div>
