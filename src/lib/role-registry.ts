...
const REGISTRY: RegisteredUser[] = [
  // ===== LEVEL 1 — Executive =====
  // { email: "chairman@ntro.gov.in", displayName: "Chairman NTRO", roleLevel: "chairman", portalRole: "ADMIN" },
  // { email: "dscientist@ntro.gov.in", displayName: "Distinguished Scientist", roleLevel: "distinguished_scientist", portalRole: "ADMIN" },
  // { email: "oscientist@ntro.gov.in", displayName: "Outstanding Scientist", roleLevel: "outstanding_scientist", portalRole: "APPROVER" },

  // ===== LEVEL 2 — Senior Management (can approve Level 3/4) =====
  // { email: "scientist.g@ntro.gov.in", displayName: "Scientist G", roleLevel: "scientist_g", portalRole: "APPROVER" },
  // { email: "scientist.f@ntro.gov.in", displayName: "Scientist F", roleLevel: "scientist_f", portalRole: "APPROVER" },
  // { email: "scientist.e@ntro.gov.in", displayName: "Scientist E", roleLevel: "scientist_e", portalRole: "APPROVER" },

  // ===== LEVEL 3 — Middle Management (needs Level 2 approval) =====
  // { email: "scientist.d@ntro.gov.in", displayName: "Scientist D", roleLevel: "scientist_d", portalRole: "OPERATOR" },
  // { email: "scientist.c@ntro.gov.in", displayName: "Scientist C", roleLevel: "scientist_c", portalRole: "OPERATOR" },

  // ===== LEVEL 4 — General Staff (needs Level 2 approval) =====
  // { email: "general@ntro.gov.in", displayName: "General Scientist", roleLevel: "general_scientist", portalRole: "OPERATOR" },
